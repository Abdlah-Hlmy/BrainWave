  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        <div className="relative mx-w-[32rem] mx-auto md:max-w-5xl max-lg:mb-10 xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <Generating className="absolute left-4 right-4 bottom-5 md:left-1/2 md:-translate-x-1/2 md:right-auto md:bottom-8 md:w-[31rem]" />
        ...
        <CompanyLogos className="hidden z-10 mt-20 relative lg:block" />
      </div>
