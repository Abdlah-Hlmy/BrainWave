    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="/hero">
          <img src={brainwave} width={190} height={120} alt="BrainWave" />
        </a>
            ...
            {navigation.map((item) => (
              <a
                ...
                className={`block relative font-code text-2xl uppercase text-n-1 transition-colors hover:text-color-1
                  ...
                  ${openNavigation ? 'md:py-7' : 'md:py-8'}
        ...
        <a className='button hidden lg:block mr-8 text-n-1/50 transition-colors hover:text-n-1' href="#signup">
            New Account
        </a>
